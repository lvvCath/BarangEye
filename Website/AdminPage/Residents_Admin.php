    ...
    <!-- Top Nav -->
            <div class="sticky">
                <div class="navbar navbar-light bg-white">
                    <div class="search navbar-left"><h4>Barangay MA-AO Residents</h4></div>
                    <div class="search navbar-right">
                        <i class="fa fa-search"></i>
                        <input id="search" name="search" class="searchInp" type="text" placeholder="Search Resident">
        ...
        <div class="row mx-5 my-4">
            <div class=" col-md-12">
                <div class="panel">
                    ...
                    <div id="container" class="panel-body table-responsive">
                        <table id="residentTable" class="table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th >Last Name</th>
...
<script src="..\Database\ResidentsCRUD\DATATABLE\resident_ajax.js"></script>